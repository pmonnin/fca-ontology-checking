...
def main():
    ...
    parser.add_argument("annlattice", help="File containing the annotated lattice")
    ...
    try:
        print("Axioms extractor from annotated lattice")
        ...
        print("Reading annotated lattice")
        lattice = LatticeManager.load_annotated_lattice(args.annlattice)
